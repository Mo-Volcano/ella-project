<template>
  <div class="checkout">
    <vContainer class="ma-0 pa-0" fluid>
      <VRow>
        <VCol cols="12" md="6" lg="7" class="order-1 order-md-0">
          <VCard
            ...
            elevation="0"
          >
            <VCardTitle class="font-weight-bold py-0">new ella demo</VCardTitle>
            <v-breadcrumbs
            ...
            <VCardActions class="justify-space-between align-center mb-7">
              <VBtn color="#6200ff" variant="elevated" class="flex-grow-1">
                <svg
                  width="70"
                  height="45"
              ...
              <VBtn color="black" variant="elevated" class="flex-grow-1">
                <svg
                  width="60"
                  height="40"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="user-name d-flex flex-row" style="gap: 15px">
              <input
                type="text"
                class="pa-3 mt-4 flex-grow-1"
                style="
                  border: 1px solid #333;
                  border-radius: 3px;
                  font-size: 14px;
            ...
            <input
              ...
              id=""
            />
            <div class="city-parent d-flex" style="gap: 15px">
              <input
                type="text"
                class="pa-3 mt-4 flex-grow-1"
                style="
            ...
            <VCardActions class="justify-end my-7">
              <VBtn
                color="#1677b0"
                class="text-white"
                variant="elevated"
            ...
            <VDivider length="100%" color="black" />
            <VCardText style="font-size: 10px; color: #777"
              >All Rights Reserved new-ella-demo
            </VCardText>
          </VCard>
        </VCol>
        <VCol cols="12" md="6" lg="5" class="bg-grey-lighten-3 pa-7">
          <VCard
            class="checkout-right bg-grey-lighten-3"
            width="100%"
            elevation="0"
            height="100%"
            min-height="300"
          >
            <VCard
              ...
              width="100%"
              height="100%"
              class="d-flex bg-grey-lighten-3 align-center justify-space-between mb-3"
            >
              <VBadge right color="grey-darken-1" :content="item.quntity">
                <img
                  :src="item.thumbnail"
                  alt=""
                  width="50"
                  height="50"
                  style="border: 7px solid #eee"
                />
              </VBadge>
              <div class="parent-title flex-grow-1 py-0">
                <VCardTitle
                  style="
                    font-size: 14px;
                    font-weight: bold;
                ...
                <VCardText
                  style="
                    ...
                    white-space: pre-wrap;
                  "
                  >{{ item.category }}</VCardText
                >
              </div>
              <VCardText class="flex-grow-0" style="font-sie: 12px; color: #777"
                >${{
                  Math.ceil(
            ...
            <VCardText
              ...
              ><span>Total</span> <span>${{ calcTotalPrice }}</span></VCardText
            >
          </VCard>
        </VCol>
      </VRow>
