<template>
  <div class="quality-features py-13 bg-grey-lighten-4">
    <v-container fluid>
      <v-row>
        <v-col
          cols="12"
        ...
        >
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              v-bind="props"
              class="text-center d-flex align-center justify-content-centx-5"
              style="height: 300px; cursor: pointer"
              :elevation="isHovering ? 2 : 0"
              :class="{
                'bg-white': !isHovering,
                'bg-blue-lighten-4': isHovering,
              }"
            >
              <div
                class="parent d-flex flex-column align-center justify-center"
              >
                ...
                >
                <v-card-text class="">{{ card.desc }}</v-card-text>
              </div>
            </v-card>
          </v-hover>
        </v-col>
  ...
  data: () => ({
    cards: [
      ...
      },
      {
        ...
        desc: "More than 10 payment methods are supported",
      ...
      },
      {
        ...
        desc: "27/4 Customer service - we are here and happy to help",
